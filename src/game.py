...
if __name__ == "__main__":
    ...
    background = pygame.image.load('../res/Background/Bckgrnd0.png').convert()
    sprite_list = SpriteSheetLoader('../res/Char/ken/Ken.png', 60, 60).getSpriteList()
    gameobj = GameObjectWithHitBox('../res/Char/ken/Ken.png', 60, 60, Point(32,130))
