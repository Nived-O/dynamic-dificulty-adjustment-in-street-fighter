...
#     def mainloop(self):
#         global round_marker, end_round, ready_text, fight_text
#         # round_marker = (False, False)
#         # end_round = False
...
#     # return self.ui.scoreP1, self.ui.scoreP2
    ...
    def mainloopa(self,ac,ac2):
        ...
        # while not end_round:
            ...
            stick_inputs_p2= [] 
            btn_inputs_P2 = []
            special = self.input_reader.getInputsa()
            # Get Player 1 hit keys
            if ac == 4:
                btn_inputs_P1.append(KEYCONST.BTNA)
            if ac == 5:
...
class InputReader:
    ...
    def getInputs(self):
        ...
        return stick_inputs_p2, btn_inputs_p2,special 
    ...
    def getInputsa(self):
        ...
        return special 
        '''stick_inputs_p1, btn_inputs_p1,stick_inputs_p2, btn_inputs_p2,'''
...
if __name__ == "__main__":
    ...
    while(n):
        ...
        player2 = Player('Ken', 120, 100, Player2=True,alt_color = True)
...
# if training_mode:
#     # Create a dummy screen surface
#     screen = pygame.Surface((320, 240))
# else:
#     # Create the actual display for gameplay mode
#     screen = pygame.display.set_mode((320, 240), 0, 32)
...
#         print('creating game...')
#         # Use None for screen if in training mode
#         game = Game( screen, background, player1, player2)
